window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function injectStyle() {
			...
			tag.textContent = [
				"button.dshAr_button{box-sizing:border-box;cursor:pointer;flex:none;width:16px;height:16px;margin:0 2px 0 0;padding:0;border:none;border-radius:4px;background:transparent;color:var(--dsw-alias-label-secondary);display:inline-flex;align-items:center;justify-content:center;opacity:1;transition:color .12s ease,background-color .12s ease,width .12s ease,padding .12s ease}",
				"button.dshAr_button:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}",
